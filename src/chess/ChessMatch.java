...
public class ChessMatch {
    ...
    private ChessPiece newPiece(String typ, Color color) {
        if (typ.equals("B")) return  new Bishop(board, color);
        if (typ.equals("N")) return  new Knight(board, color);
        if (typ.equals("Q")) return  new Queen(board, color);
    ...
    public void nextTurn() {
        turn++;
        currentPlayer = (currentPlayer == Color.WHITE) ? Color.BLACK : WHITE;
